...
if not os.path.isfile("apktool.jar"):
	...
	print("It will download from https://bitbucket.org/iBotPeaches/apktool/downloads/apktool_2.0.0rc2.jar.")
	print("You can choose to stop the script here and download apktool yourself.")
	print("The tool must be named apktool.jar and be placed in the same directory as this script.")
	answer = ''
	while answer!='n' and answer!='y':
		answer = input("Do you wish to continue and download apktool? [y/n] ").lower()
	if answer=='n':
		sys.exit(0)
...
if not os.path.isfile("smali.jar"):
	...
	print("It will download from https://bitbucket.org/JesusFreke/smali/downloads/smali-2.0.3.jar.")
	print("You can choose to stop the script here and download Smali yourself.")
	print("The tool must be named smali.jar and be placed in the same directory as this script.")
	answer = ''
	while answer!='n' and answer!='y':
		answer = input("Do you wish to continue and download Smali? [y/n] ").lower()
	if answer=='n':
		sys.exit(0)
...
if not os.path.isfile("dex2jar.zip"):
	...
	print("It will download from https://dex2jar.googlecode.com/files/dex2jar-0.0.9.15.zip.")
	print("You can choose to stop the script here and download dex2jar yourself.")
	print("The tool must be named dex2jar.zip and be placed in the same directory as this script.")
	answer = ''
	while answer!='n' and answer!='y':
		answer = input("Do you wish to continue and download dex2jar? [y/n] ").lower()
	if answer=='n':
		sys.exit(0)
